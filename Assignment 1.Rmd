...
```{r}
print ("Metro Area with fewest icu beds")
...
## Determine Ratio of ICU beds available for Every 10k of population deemed at risk in FL
```{r}
...
## Determine Avg ICU Beds per Hospital in FL metro areas
